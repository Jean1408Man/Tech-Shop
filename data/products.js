...
export const categories = [
  {
    ...
    description:
      "Descubre las últimas tendencias en moda con precios increíbles. Vestidos, camisetas y accesorios para todos los estilos.",
  },
  {
    name: "Electrónica",
    slug: "electronics",
    ...
    description:
      "Tecnología de vanguardia a precios accesibles. Smartphones, auriculares y gadgets que harán tu vida más fácil.",
  },
  {
    name: "Hogar y cocina",
    slug: "home-kitchen",
    ...
    description:
      "Todo lo que necesitas para tu hogar. Utensilios de cocina, decoración y artículos prácticos para tu espacio.",
  },
  {
    name: "Belleza",
    slug: "beauty",
    ...
    description:
      "Productos de belleza y cuidado personal de alta calidad. Maquillaje, cremas y todo para realzar tu apariencia.",
  },
  {
    name: "Juguetes",
    slug: "toys",
    ...
    description:
      "Juguetes educativos y divertidos para niños de todas las edades. Fomenta la creatividad y el aprendizaje.",
  },
  {
    name: "Deportes",
    slug: "sports",
    ...
    description:
      "Equípate para tus actividades deportivas con nuestra selección de productos. Ropa, accesorios y artículos profesionales.",
  },
];
