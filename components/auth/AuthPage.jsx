        ...
        <div className="mx-auto max-w-md rounded-lg bg-white p-6 shadow md:p-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit} noValidate>
            {fields.map((field) => (
              <div key={field.name}>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-400 transition-colors duration-200 focus:border-primary focus:outline-none"
                />
                {errors[field.name] && (
            ...
            <button
              ...
              className="w-full rounded-md bg-primary px-4 py-2 font-semibold text-white transition-colors duration-200 hover:bg-primary-dark disabled:cursor-not-allowed disabled:bg-gray-400"
            >
