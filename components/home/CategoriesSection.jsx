...
export default function CategoriesSection({ categories = [] }) {
  ...
  return (
    <section className="w-full max-w-[1856px] h-[512px] mx-auto relative overflow-hidden px-4 py-8 border-t-2 border-primary-dark">
      <Image
      ...
      <div className="bg-gradient-to-t from-black/60 to-transparent h-full">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-3/4 relative overflow-hidden h-64 sm:h-80 md:h-96">
            {selectedCategory && (
              <>
                <div className="absolute inset-0 flex flex-col items-end justify-center p-6 text-end">
