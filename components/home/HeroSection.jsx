  ...
  return (
    <section className="relative h-56 sm:h-64 md:h-80 lg:h-96 w-full max-w-[1856px] mx-auto grid place-items-center">
      <div>
        ...
        <div className="absolute left-0 top-[63.66%] scale-50 md:scale-75 lg:scale-100 origin-left">
          <Image src={figure2} alt="Figure 2" />
        </div>
        <div className="absolute left-[4.71%] top-[43.66%] scale-50 md:scale-75 lg:scale-100 origin-center">
          <Image src={figure3} alt="Figure 3" />
        </div>
        <div className="absolute left-[5%] bottom-0 scale-50 md:scale-75 lg:scale-100 origin-bottom">
          <Image src={figure4} alt="Figure 4" />
        </div>
        <div className="absolute right-0 top-[38.23%] scale-50 md:scale-75 lg:scale-100 origin-right">
          <Image src={figure5} alt="Figure 5" />
        </div>
        <div className="absolute right-[12.35%] top-[62.20%] scale-50 md:scale-75 lg:scale-100 origin-center">
          <Image src={figure8} alt="Figure 8" />
        </div>
        <div className="absolute right-[19.65%] top-[10.36%] scale-50 md:scale-75 lg:scale-100 origin-center">
          <Image src={figure7} alt="Figure 7" />
        </div>
        <div className="absolute right-0 top-0 scale-50 md:scale-75 lg:scale-100 origin-top-right">
          <Image src={figure6} alt="Figure 6" />
        </div>
        <div className="absolute right-[32.11%] top-0 scale-50 md:scale-75 lg:scale-100 origin-top">
      ...
      >
        ...
        <p className="text-gray-700 mt-2 max-w-96 lg:max-w-2xl text-base">
          Descubre productos únicos a precios inigualables. Desde ropa hasta
          electrónica, tenemos todo lo que buscas.
        </p>
        <Link href="/#explore" legacyBehavior>
          <a className="mt-3 sm:mt-4 inline-block bg-primary text-white px-4 sm:px-5 py-1.5 sm:py-2 rounded-md shadow hover:bg-primary-dark transition-colors duration-200 text-base">
            Explorar ahora
          </a>
        </Link>
      </div>
